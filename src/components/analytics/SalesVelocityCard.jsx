...
export const SalesVelocityCard = ({ velocity = { value: 0, growth: 0 } }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col h-[260px] justify-between relative group overflow-hidden">
      ...
      <div>
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">Speed at which leads generate revenue</p>
          </div>
      ...
      {/* Progress status bar */}
      <div className="bg-gray-50 dark:bg-gray-900/30 p-3 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center justify-between text-xs">
        <span className="font-semibold text-slate-500 dark:text-slate-400">Funnel Flow Rating:</span>
