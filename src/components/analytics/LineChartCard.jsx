  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-slate-900 text-slate-100 p-3.5 rounded-2xl shadow-xl border border-slate-750 text-xs">
        ...
        <p className="mt-1 text-emerald-450 font-bold">{payload[0].value}%</p>
      </div>
    );
  }
  return null;
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-150 dark:border-gray-700 flex flex-col h-[400px]">
      <div className="mb-6">
        ...
        <p className="text-xs text-slate-405 dark:text-slate-500">Won deals relative to total leads created per month</p>
      </div>
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Line 
              ...
              stroke="#22C55E" 
              strokeWidth={3}
              dot={{ stroke: '#22C55E', strokeWidth: 2.5, fill: '#FFFFFF', r: 4.5, activeDot: { r: 6.5 } }}
