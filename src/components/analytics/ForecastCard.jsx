    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-150 dark:border-gray-700 flex flex-col h-[260px] justify-between relative group overflow-hidden">
      ...
      <div>
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-xs text-slate-405 dark:text-slate-500 mt-0.5">Predicted revenue for the upcoming month</p>
          </div>
      ...
      <div className="space-y-1.5">
        <div className="flex justify-between items-center text-xs">
          <span className="font-bold text-slate-505 dark:text-slate-455">Model Confidence:</span>
